    ...
    <header className="fixed top-0 inset-x-0 z-50 border-b border-primary/15 bg-bg/80 backdrop-blur-md">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 h-20 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <a
            href="/reserva"
            className="inline-flex items-center justify-center gap-2 rounded-full font-bold text-sm px-5 py-2.5 bg-gold text-bg hover:bg-gold-soft shadow-gold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-bg"
          >
            Reserve seu Evento
          </a>
          <MobileNav />
